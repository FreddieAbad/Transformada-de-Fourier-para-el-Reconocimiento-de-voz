...
def predict(file):
    ...
    if answer == 0:
        ...
        print("Prediccion: Collaguazo")
        resultadoPredecir="Cristian Collaguazo"
    elif answer == 2:
        print("Prediccion: Vizhnay")
        resultadoPredecir="Esteban Vizhnay"
    else:
...
def fceAG():
    predict("/home/fred/Escritorio/CNN/DatosPruebaPresentacion/collaguazo"+str(segundoMuestra)+".png")
def fceAB():
    predict("/home/fred/Escritorio/CNN/DatosPruebaPresentacion/vizhnay"+str(segundoMuestra)+".png")
top = Tk.Tk()
...
B3 = Tk.Button(top, text = 'Muestra Vizhnay', command = fceAG, font = (None, 14),height = 2, width = 15)
B4 = Tk.Button(top, text = 'Muestra Collaguazo', command = fceAB, font = (None, 14),height = 2, width = 15)
